...
Eight isolated, independently deployable concept websites for the WebiQQ portfolio. These directories do not import from or modify the main WebiQQ application.
...
| `abu-shehab/` | Abu Shehab (مطعم أبو شهاب) | `abushehab.webiqq.com` |
...
Open `/` for the shareable WebiQQ Concept Collection homepage linking all eight showcases.
